...
public class LoginActivity extends AppCompatActivity {
    ...
    public void registry(){
        String finalMail = mPhoneNum.getText().toString() + "@ChatHack.com";
        mAuth.createUserWithEmailAndPassword(finalMail, "myPassword").addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            @Override
